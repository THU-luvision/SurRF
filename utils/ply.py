...
def down_sample(datasetName,
    ...
    for model in modelList:
        if (datasetName == 'DTU'):
            ...
            pcd.estimate_normals(
                search_param=o3d.geometry.KDTreeSearchParamHybrid(radius=resol_gt_render * 4, max_nn=40))  # 50 30
...
if __name__ == '__main__':
    ...
    for resol_gt_render in [1.0, 2.0, 4.0, 8.0]:
        down_sample(datasetName='DTU',
                    ...
                    gtRenderNamePattern='preprocess/ply_rmvs/#/$_surface_xyz_flow.ply'.replace('$',
                                                                                               str(resol_gt_render)),
